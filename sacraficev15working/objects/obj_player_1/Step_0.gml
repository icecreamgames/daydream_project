...
if (keyboard_check(ord("W")))
{
    if !( place_meeting(x, y - move_speed, obj_wall)
       || place_meeting(x, y - move_speed, obj_gate)
       || place_meeting(x, y - move_speed, obj_gate_2) )
    {
        y -= move_speed;
...
if (keyboard_check(ord("A")))
{
    if !( place_meeting(x - move_speed, y, obj_wall)
       || place_meeting(x - move_speed, y, obj_gate)
       || place_meeting(x - move_speed, y, obj_gate_2) )
    {
        x -= move_speed;
